...
let pizzaToppings = ["cheese","sausage","bacon","pineapple"];
...
function greetCustomer() {
    ...
    for (let i = 0; i < pizzaToppings.length; i++) {
        string += pizzaToppings[i] + ", ";
    }
    console.log("Welcome guest. Our toppings are: ", string);
}
...
function getPizzaOrder(size, crust, ...toppings) {
 ...
 const pizzaOrder = getPizzaOrder("large", "thin", "cheese", "sausage", "bacon");
...
function servePizza(pizzaObject) {
   const stuff = Object.values(pizzaObject);
console.log("Order up! Here's your large thick crust pizza with " + stuff + ". Enjoy!");
}
